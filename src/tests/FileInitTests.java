...
/* FileInitTests class - contains our tests for file init.
 * 
 * @Author: Carson D.
 * @Author: Charlie D.
 * 
...
public class FileInitTests {
	...
	public void testRoomLabels() {
		...
		assertEquals("Cargo", board.getRoom('C').getName() );
	...
	// one cell that is not a doorway.
	// These cells are white on the planning spreadsheet
	@Test
	public void FourDoorDirections() {
		BoardCell cell = board.getCell(3, 14);
	...
	public void testRooms() {
		...
		room = board.getRoom( cell ) ;
		assertTrue( room != null );
		assertEquals( room.getName(), "Hydroponics" ) ;
		...
		room = board.getRoom( cell ) ;
		assertTrue( room != null );
		assertEquals( room.getName(), "Reactor" ) ;
